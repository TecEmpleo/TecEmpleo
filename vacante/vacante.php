...
<center>
    ...
    <a href="../categoria/categorias.php"><i class="ri-building-line"></i>Categorias</a>
    <a href="../empresa/empresa.php"><i class="ri-layout-grid-fill"></i>Empresas</a>
    <li>
</div>
    <br>
    <div class="container">
...
<script src="../javascript/vacante.js"></script>
